	...
	<div style="margin: 0px auto;">
		<div class="classified-search">
			<div class="classified" v-for="(item,index_) in config">
				...
				<div class="item-option" :class="{'selected':selected[index_]!=null&&selected[index_].expanded==true }">
					
						<!-- <el-tooltip class="item" effect="light"  :content="option.label" placement="top-start"> -->
						<span v-for="(option,subIndex_) in item.options" :key="subIndex_" :class="{'selected':selected[index_]!=null&&selected[index_].value==option.value,'disabled' :option.disabled&&option.disabled==true}" @click="doSelectHandler(index_,option)">
							{{option.label}}
						</span>
		<!-- 			</el-tooltip> -->
				</div>
